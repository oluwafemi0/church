...
function Modal() {
  ...
  return (
    <>
      <button
        className="bg-indigo-500 text-white  font-bold  text-lg px-5 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
        type="button"
